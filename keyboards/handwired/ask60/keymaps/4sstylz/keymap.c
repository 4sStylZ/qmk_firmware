...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    KC_LSPO, KC_NUBS, KC_Z, KC_X   , KC_C , KC_V , KC_B  , KC_N , KC_M  , KC_COMM, KC_DOT , KC_SLSH, KC_RSPC, KC_RSPC,
    KC_LCPO, KC_LGUI,       KC_LALT,                              KC_SPC,          KC_RGUI, KC_APP , KC_RALT, KC_RCPC
  ),
  [1] = LAYOUT( \
    ...
    _______    , _______     , LSFT(KC_DEL), LCTL(KC_INS), LSFT(KC_INS), KC_DEL , KC_ENT , KC_LEFT, KC_DOWN , KC_RIGHT, BL_TOGG, BL_STEP , BL_BRTG         ,
    _______    , _______     , KC_MUTE     , KC_VOLD     , KC_VOLU     , ALT_TAB, _______, _______, _______ , _______ , _______, RESET   , _______, _______,
